...
1. Go to <a href="https://discord.com/developers/applications" target="_blank">Discord Developers Portal Website</a>
...
2. Click on the `New Application` button, name your application, accept the Developer Terms of Service and click on the `Create` button
   ...
   ![New Application](../../../assets/images/en/managing-your-application/NewApplicationButton.webp)
   ![Create An Application](../../../assets/images/en/managing-your-application/CreateAnApplication.webp)

3. **(OPTIONAL)** You can add an avatar and an about me to your application

   ![Application](../../../assets/images/en/managing-your-application/Application.webp)
...
4. Click on the `Bot` button and click on the `Reset Token` button
   ...
   ![Reset Token](../../../assets/images/en/managing-your-application/ResetTokenButton.webp)
   ![Reset Bot Token](../../../assets/images/en/managing-your-application/ResetBotToken.webp)

5. Finally, click on the `Copy` button

   ![Copy](../../../assets/images/en/managing-your-application/CopyButton.webp)
...
![Public Bot](../../../assets/images/en/managing-your-application/PublicBotOption.webp)
...
1. Click on the `OAuth2` button and go below to `OAuth2 URL Generator`
   ...
   ![OAuth2 URL Generator](../../../assets/images/en/managing-your-application/OAuth2URLGenerator.webp)

2. Select the `Bot` Scope and select the following permissions

   ![Bot Scope](../../../assets/images/en/managing-your-application/BotScopeButton.webp)
   ...
   ![Bot Permissions](../../../assets/images/en/managing-your-application/BotPermissions.webp)

3. Finally, go below to `Generated URL`, click on the `Copy` button and add your Application to your server

   ![Generated URL](../../../assets/images/en/managing-your-application/GeneratedURL.webp)
