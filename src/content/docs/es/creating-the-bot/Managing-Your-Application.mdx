---
title: Gestionando tu Aplicación
sidebar:
  order: 1
---
...
:::danger
Si el token se ha filtrado, deberías ir lo más rápido posible al Portal de Desarrolladores de Discord para restablecer el token, haciendo que el token actual sea inválido.
