...
2. Click on the `Download Node.js (LTS)` button
   ...
   ![Download Node.js LTS](../../../assets/images/en/first-steps/DownloadNodeJsButton.webp)
...
2. Click on the `Download for Windows` button
   ...
   ![Download for Windows](../../../assets/images/en/first-steps/DownloadForWindowsButton.webp)
