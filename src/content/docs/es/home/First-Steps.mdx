...
2. Haz clic en el botón `Descargar Node.js (LTS)`
   ...
   ![Descargar Node.js LTS](../../../../assets/images/es/first-steps/DownloadNodeJsButton.webp)
...
2. Haz clic en el botón `Descargar para Windows`
   ...
   ![Descargar para Windows](../../../../assets/images/es/first-steps/DownloadForWindowsButton.webp)
