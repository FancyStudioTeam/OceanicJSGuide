...
```bash title="Verificando tu versión de Node.js" frame="terminal"
...
4. **(OPCIONAL)** Si tienes una terminal abierta, reiníciala y ejecuta el comando `node -v` para verificar que Node.js se haya instalado con una versión compatible
